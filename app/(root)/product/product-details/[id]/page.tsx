...
import { fakeMedicines } from '@/lib/constants';
...
const ProductDetails = async ({ params }: { params: { id: string } }) => {
  ...
  const relatedProduct: Product[] = fakeMedicines.filter(product => product.category === SingleProduct.category && product.id !== id);
